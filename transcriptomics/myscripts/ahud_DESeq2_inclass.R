### this is my .r script for exploring the A hudsonica Rseq data 
### using DESeq2
...
#Transform data so that we can make a PCA plot
...
# Note any outliers
# Maybe one from F2
# ouliers - maybe one form AH (OA) F2 rep 2 

# Make a cluster tree to look at samples 
...
# save a file for me of the plot we made

png("./myresults/PCA_allGens.png", res=300, height=8, width=10, units="in")
